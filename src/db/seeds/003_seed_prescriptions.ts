...
// Define interface for medical record data structure
...
export const seed = async () => {
  ...
  // Get all medical records to link prescriptions
  ...
  const medications = [
    ...
    { name: "Prednisone", dosage: "10mg", frequency: "Once daily for 5 days" },
  ];
